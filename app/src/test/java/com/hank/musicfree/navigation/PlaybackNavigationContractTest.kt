    ...
    fun `song list playback callbacks do not navigate to player`() {
        val forbiddenNavigation = listOf(
            ForbiddenPlaybackNavigation(
                relativePath = "feature/search/src/main/java/com/hank/musicfree/feature/search/SearchViewModel.kt",
            ...
            ForbiddenPlaybackNavigation(
                relativePath = "feature/search/src/main/java/com/hank/musicfree/feature/search/SearchScreen.kt",
            ...
            ForbiddenPlaybackNavigation(
                relativePath = "feature/home/src/main/java/com/hank/musicfree/feature/home/searchmusiclist/SearchMusicListScreen.kt",
            ...
            ForbiddenPlaybackNavigation(
                relativePath = "feature/home/src/main/java/com/hank/musicfree/feature/home/local/LocalScreen.kt",
                normalizedSnippet = "viewModel.playItem(item,items)onNavigateToPlayer()",
                description = "navigates after local song-list playback",
            ),
            ForbiddenPlaybackNavigation(
                relativePath = "feature/home/src/main/java/com/hank/musicfree/feature/home/history/HistoryScreen.kt",
            ...
            ForbiddenPlaybackNavigation(
                relativePath = "feature/home/src/main/java/com/hank/musicfree/feature/home/playlist/PlaylistDetailScreen.kt",
            ...
            ForbiddenPlaybackNavigation(
                relativePath = "feature/home/src/main/java/com/hank/musicfree/feature/home/pluginsheet/PluginSheetDetailScreen.kt",
                normalizedSnippet = "if(ok)onNavigateToPlayer()",
                description = "navigates after plugin sheet playback success",
            ),
            ForbiddenPlaybackNavigation(
                relativePath = "feature/home/src/main/java/com/hank/musicfree/feature/home/toplist/TopListDetailScreen.kt",
                normalizedSnippet = "if(ok){onNavigateToPlayer()}",
                description = "navigates after top list playback success",
            ),
            ForbiddenPlaybackNavigation(
                relativePath = "feature/home/src/main/java/com/hank/musicfree/feature/home/albumdetail/AlbumDetailScreen.kt",
                normalizedSnippet = "if(ok)onNavigateToPlayer()",
                description = "navigates after album playback success",
            ),
            ForbiddenPlaybackNavigation(
                relativePath = "feature/home/src/main/java/com/hank/musicfree/feature/home/artistdetail/ArtistDetailScreen.kt",
                normalizedSnippet = "if(ok)onNavigateToPlayer()",
