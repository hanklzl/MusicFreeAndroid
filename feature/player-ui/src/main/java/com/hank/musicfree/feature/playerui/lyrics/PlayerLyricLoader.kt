...
class PlayerLyricLoader @Inject constructor(
    ...
    private fun localDocument(music: MusicItem, cache: LyricCache?): com.hank.musicfree.core.model.LyricDocument? {
    ...
    private fun cachedDocument(music: MusicItem, target: MusicItem, cache: LyricCache?): com.hank.musicfree.core.model.LyricDocument? {
