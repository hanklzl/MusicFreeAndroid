...
class BackupRepositoryTest {
    ...
    fun `export writes archive to uri`() = runBlocking {
        ...
        ZipFile(output).use { zip ->
            ...
            assertEquals("com.hank.musicfree", restoredManifest.sourcePackageName)
    ...
    private object NoOpLogger : MfLogger {
        override fun trace(category: com.hank.musicfree.logging.LogCategory, event: String, fields: Map<String, Any?>) {}
        override fun detail(category: com.hank.musicfree.logging.LogCategory, event: String, fields: Map<String, Any?>) {}
        override fun error(
            category: com.hank.musicfree.logging.LogCategory,
            event: String,
            throwable: Throwable?,
