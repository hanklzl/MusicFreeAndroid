...
| [docs/superpowers/specs/2026-05-13-maestro-real-network-smoke-design.md](./superpowers/specs/2026-05-13-maestro-real-network-smoke-design.md) | 当前规范（Maestro 真实网络 smoke 验收） | 是（作为实现计划输入） | 使用默认插件/订阅真实网络链路编写 Maestro smoke、运行脚本与 logcat/结构化日志验收文档的设计 |
